...
const {imageShortcode, includeRaw, liteYoutube, gifShortcode} = require('./config/shortcodes/index.js');
...
module.exports = eleventyConfig => {
  ...
  eleventyConfig.addNunjucksAsyncShortcode('eleventyGif', gifShortcodeShortcode);
